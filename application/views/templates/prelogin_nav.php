                ...
                <ul class="nav navbar-nav ml-auto">
                    ...
                    <li class="dropdown nav-item"><a class="nav-link dropdown-toggle" data-toggle="dropdown"
                        ...
                        <div class="dropdown-menu" role="menu">
                            <a class="nav-link dropdown-item" role="presentation" href="createaccount">Student Account</a>
                            <a class="nav-link dropdown-item" role="presentation" href="createt">Faculty Account</a>
                        </div>
                    </li>
                </ul>
            </div>
