...
<nav class="navbar navbar-light navbar-expand-md navigation-clean-search shadow-sm p-3 bg-white rounded">
    <div class="container"><a class="navbar-brand" href="<?php echo base_url('home'); ?>">Distance Learning
            Application</a>
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" data-toggle="dropdown"
                       aria-expanded="false" href="#">
                        ...
                        <?php echo ucwords(strtolower($loggedInUserDetail['firstname'] . ' ' . $loggedInUserDetail['lastname'])); ?>
                    </a>
